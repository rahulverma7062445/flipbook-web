var htmlConfig = {
  bookConfig: {
    ...
    updateURLForPage: "No",
    googleAnalyticsID: "",
    appLogoIcon: "files/images/sopra-logo.svg",
    appLogoOpenWindow: "Blank",
    logoPadding: 0,
    logoTop: 0,
    logoHeight: 40,
    backGroundImgURL: "files/images/background.jfif",
    ...
    BackgroundSoundURL: "./files/soundfiles/sound.mp3",
